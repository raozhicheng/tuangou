<?php	
	...
	class Install {
		...
		function __construct(){
			$this->process=new Process("../config.inc.php", "lscms_db.sql");
			$this->installFrom=new InstallFrom("POST",$_SERVER['REQUEST_URI']);
			$this->messageList="";
		}
		...
		function exeStep($step){
			switch($step) {
				...
				case 4:
					...
					break;
				case 5:
					if(file_put_contents ("../install_lock.txt", "CMS INSTALL OK ...")){
