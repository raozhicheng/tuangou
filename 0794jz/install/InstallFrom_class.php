<?php
	...
	class InstallFrom {	
		...
		function getAgreement(){
			...
			$fc.='欢迎您使用乐尚团购管理系统1.0，请认真阅读以下安装条款后进行安装.';
			$fc.='</div>';
			$fc.='<form method="'.$this->method.'" action="'.$this->action.'" class="'.$this->class.'">';
			$fc.='<div class="body-box">';
			$fc.='<div class="center red-font">乐尚团购许可协议</div>';
			$fc.='<div class="license">';
			$fc.='<ol>';
			$fc.='<li>乐尚团购管理系统的所有权归<a href="http://www.leesuntech.com" target="_blank"><span class="red-font">乐尚团购</span></a>所有,未经允许不得用于任何商业用途.</li>';
			$fc.='<li>用户可以无条件使用软件的免费版本,收费用户将享有永久免费升级服务.</li>';
			$fc.='<li>任何使用免费版本的用户,乐尚团购将不提供任何使用保障、技术服务，也不承担任何因使用本软件而产生问题的相关责任。</li>';
			$fc.='<ol>';	
			$fc.='</div></div>';
