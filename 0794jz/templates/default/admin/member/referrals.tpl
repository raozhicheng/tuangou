...
<body>
<div id="location"><strong>·返利管理</strong></div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="cdcdcd">
  <tr>
	<td bgcolor="#EAEAEA"><div align="center"><strong  style="color:red">暂无返利列表</strong></div></td>
    </tr>
</table>
<{else}>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="cdcdcd">
  <tr>
    ...
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>购买人</strong></div></td>
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>返利金额</strong></div></td>
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>返利积分</strong></div></td>
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>订单号</strong></div></td>
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>下单时间</strong></div></td>
    <td width="10%" bgcolor="#EAEAEA"><div align="center"><strong>返利发放时间</strong></div></td>
  ...
  <tr>
    ...
    <td bgcolor="f5f5f5"><div align="center"><a href="?act=referrals&page=<{$pageinfo.current_page}>&id=<{$var.id}>&edit=del" onClick="return confirm('确定要删除<{$var.name}>吗？')">彻底删除</a></div></td>
  </tr>
  <{/foreach}>
  </table>
<{/if}>
  ...
  <tr>
    <td bgcolor="#F5F5F5" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          第一页
          <{else}>
          <a href="?act=referrals&page=1">第一页</a>
          <{/if}>
&nbsp;&nbsp;｜&nbsp;&nbsp;
		  <{if $pageinfo.prev_page}>
		  <a href="?act=referrals&page=<{$pageinfo.prev_page}>">上一页</a>
          <{else}>上一页<{/if}>
        &nbsp;&nbsp;|&nbsp;&nbsp;
            <{if $pageinfo.next_page}>
            <a href="?act=referrals&page=<{$pageinfo.next_page}>">下一页</a>
            <{else}>下一页<{/if}>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <{if $pageinfo.current_page==$pageinfo.page_num}>
            最后一页
            <{else}>
            <a href="?act=referrals&page=<{$pageinfo.page_num}>">最后一页</a>
            <{/if}>
