...
<body>
<div id="location"><strong>·<{$submitButton}>供应商</strong></div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="cdcdcd">
  <tr>
   ...
   <tr>
    <td bgcolor="#EAEAEA" class="table_left_title">供应商标志图片：</td>
    <td bgcolor="f5f5f5"><input type="file" name="uploadPic" id="uploadPic"></td>
  </tr>
  
  <tr>
    <td bgcolor="#EAEAEA" class="table_left_title">标志图片预览：</td>
    <td bgcolor="f5f5f5"><{if $getSupplier.preview}><input type="hidden" name="preview" value="<{$getSupplier.preview}>"><img src="<{$bmpPath}>" alt="图片预览" width=100 height="100" id="previewPic"><{else}><input type="hidden" name="preview" value="../images/no_image.gif"><img src="images/no_image.gif" alt="图片预览" width=100 height="100" id="previewPic"/><{/if}></td>
  </tr>
  ...
  <tr>
    <td bgcolor="#EAEAEA" class="table_left_title">供应商描述：</td>
