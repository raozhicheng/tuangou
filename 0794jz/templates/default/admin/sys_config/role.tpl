...
<body>
<div id="location"><strong>·管理员分组列表</strong></div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="cdcdcd">
  <tr>
	<td bgcolor="#EAEAEA"><div align="center"><strong  style="color:red">暂无管理员分组列表</strong></div></td>
    </tr>
</table>
<{else}>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="cdcdcd">
  ...
  <tr>
    ...
    <td bgcolor="f5f5f5"><div align="center"><a href="?act=add_role&edit=mod&id=<{$var.id}>">编辑</a> | <a href="?act=role&page=<{$pageinfo.current_page}>&id=<{$var.id}>&edit=del" onClick="return confirm('确定要删除<{$var.name}>吗？')">删除</a></div></td>
  </tr>
  <{/foreach}>
  </table>
<{/if}>
    ...
    <td bgcolor="#F5F5F5" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="19%"><table width="164" border="0" cellspacing="3" cellpadding="0">
            <tr>
              <td><input type="button" name="add" class="admin_button" value="新增" onClick="window.location.href='main.php?act=add_role&edit=add'"/></td>
          ...
          第一页
          <{else}>
          <a href="?act=role&page=1">第一页</a>
          <{/if}>
&nbsp;&nbsp;｜&nbsp;&nbsp;
		  <{if $pageinfo.prev_page}>
		  <a href="?act=role&page=<{$pageinfo.prev_page}>">上一页</a>
          <{else}>
          上一页
          <{/if}>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <{if $pageinfo.next_page}>
            <a href="?act=role&page=<{$pageinfo.next_page}>">下一页</a>
            <{else}>
            下一页
           <{/if}>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            ...
            最后一页
            <{else}>
            <a href="?act=role&page=<{$pageinfo.page_num}>">最后一页</a>
            <{/if}>
