                ...
                <div class="member_box">
                	<div class="data_list">
                        <table cellspacing="1" cellpadding="5" border="0" width="100%" bgcolor="#CCCCCC">
                              <tr>
                                  <th width=30% bgcolor="#EEEEEE">订单号</th>
                                  <th width=20% bgcolor="#EEEEEE">下单时间</th>
                                  <th width=15% bgcolor="#EEEEEE">支付总金额</th>									
                                  <th width=16% bgcolor="#EEEEEE">订单状态</th>
                              ...
                              <tr class="red_l">
                                  ...
                                  <td bgcolor="#FFFFFF" align="center">支付:[<{$list.pay_status_cn}>]<br />配送:[<{$list.delivery_status_cn}>]<br />结单:[<{$list.order_status_cn}>]<{if $list.after_sale>0}><br />售后：[<{$list.after_sale_cn}>]<{/if}></td>
