        	...
        	<div class="user_f">
            	<div class="tit">修改密码</div>
                     ...
                     <form method="post" action="<{$Web_link|name:"do_modify_password"}>" >
                        	<ul>
    <li><span class="t"><label for="email">新密码:</label></span><span class="i"><input type="password" name="user_pwd" id="user_pwd" class="input_box" value="" /></span></li>
    <li><span class="t"><label for="email">确认密码:</label></span><span class="i"><input type="password" name="user_pwd_confirm" id="user_pwd_confirm" class="input_box" value="" /></span></li>
     <li><span class="t"></span><span class="i"><input type="hidden" value="<{$user_info.password_verify}>" name="code" />
									<input type="hidden" value="<{$user_info.id}>" name="id" /><input type="submit"  class="submit_button" value="提交" /></span></li>
 </ul></form>
                     </div>
            </div>
        	<div class="clear"></div>
