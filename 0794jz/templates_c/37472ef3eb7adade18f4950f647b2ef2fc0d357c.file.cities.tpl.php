...
">
    ...
    <td bgcolor="f5f5f5"><div align="center"><?php echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['var']->value['is_default'],1,'是'),0,'否');?>
...
" style="color:red">[设置为默认]</a><?php }?></div></td>
    <td bgcolor="f5f5f5"><div align="center"><?php echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['var']->value['is_open'],1,'是'),0,'否');?>
</div></td>
        ...
        <tr>
          <td width="19%"><table width="164" border="0" cellspacing="3" cellpadding="0">
            <tr>
             ...
             <?php if ($_smarty_tpl->tpl_vars['pageinfo']->value['row_total']){?> <td><input type="submit" name="dels" class="admin_button" value="删除" onClick="return confirm('你确定要删除选中的城市吗?')" /></td><?php }?>
            </tr>
          </table></td>
          <td width="81%">
