...
">编辑</a> | <a href="?act=role&page=<?php echo $_smarty_tpl->tpl_vars['pageinfo']->value['current_page'];?>
        ...
        <tr>
          <td width="19%"><table width="164" border="0" cellspacing="3" cellpadding="0">
            <tr>
              ...
              <?php if ($_smarty_tpl->tpl_vars['pageinfo']->value['row_total']){?><td><input type="submit" name="dels" class="admin_button" value="删除" onClick="return confirm('你确定要删除选中的管理员分组吗?')" /></td><?php }?>
            </tr>
          </table></td>
          <td width="81%">
