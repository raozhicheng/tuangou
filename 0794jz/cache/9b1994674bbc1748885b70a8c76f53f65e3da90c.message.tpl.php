...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_540f9813a15b71_73717523',
  'has_nocache_code' => true,
  'cache_lifetime' => 86400,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540f9813a15b71_73717523')) {function content_540f9813a15b71_73717523($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_block_messageGroup')) include '/applications/xampp/xamppfiles/htdocs/xampp/0794jz/libs/definePlugins/block.messageGroup.php';
...
<link href="/xampp/0794jz/templates/default/css/message.css" rel="stylesheet" type="text/css" />
          ...
          <div class="message">
          	<div class="tit">
            	<ul>
                	...
                	<?php $_smarty_tpl->smarty->_tag_stack[] = array('messageGroup', array('name'=>"row",'num'=>"6",'preset'=>$_smarty_tpl->tpl_vars['mg_info']->value['preset'])); $_block_repeat=true; echo smarty_block_messageGroup(array('name'=>"row",'num'=>"6",'preset'=>$_smarty_tpl->tpl_vars['mg_info']->value['preset']), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                		<li <?php if ($_smarty_tpl->tpl_vars['row']->value['current']==1){?>class="cur"<?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['row']->value['link'];?>
"><?php echo $_smarty_tpl->tpl_vars['row']->value['show_name'];?>
</a></li>
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_messageGroup(array('name'=>"row",'num'=>"6",'preset'=>$_smarty_tpl->tpl_vars['mg_info']->value['preset']), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
            ...
            <div class="content">
                	...
                	<?php $_smarty_tpl->smarty->_tag_stack[] = array('message', array('name'=>"list",'title_len'=>"30")); $_block_repeat=true; echo smarty_block_message(array('name'=>"list",'title_len'=>"30"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                        <div class="mess_box">
                        	<ul>
                            	<li class="title"><b class="grey_n">标题：</b><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="grey_n">时间：</b><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['list']->value['update_time'],"%Y-%m-%d %H:%M:%S");?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="grey_n">用户：</b><?php echo $_smarty_tpl->tpl_vars['list']->value['username'];?>
</li>
                                <li class="con"><b class="grey_n">留言内容：</b><?php echo $_smarty_tpl->tpl_vars['list']->value['content'];?>
</li>
                                <li class="reply"><b class="grey_n">回复内容：</b><?php if ($_smarty_tpl->tpl_vars['list']->value['admin_reply']){?><?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['admin_reply']);?>
<?php }else{ ?>暂无回复<?php }?></li>
                                
                            </ul>
                        </div>
                        <?php $_smarty_tpl->tpl_vars['p'] = new Smarty_variable(smarty_modifier_type($_smarty_tpl->tpl_vars['pages']->value,"other",$_smarty_tpl->tpl_vars['message_num']->value), true, 0);?>
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_message(array('name'=>"list",'title_len'=>"30"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
页</li>
            ...
            <div class="message_form red_l">
            	...
            	<?php if ($_smarty_tpl->tpl_vars['user']->value){?>
                <form method="post" id="add_message" action="<?php echo smarty_modifier_name($_smarty_tpl->tpl_vars['Web_link']->value,"message");?>
&act=add" name="message" >
                	<ul>
                        ...
                        <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['mg_info']->value['id'];?>
" name="group_id">
                        <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['mg_info']->value['is_member'];?>
" name="is_member">
                        <li style="margin-left:40px;"><input type="submit" class="formbutton" name="commit" value="提交"></li>
                    </ul>
                 </form>
                <?php }else{ ?>
                	您还未&nbsp;&nbsp;<a href="<?php echo smarty_modifier_name($_smarty_tpl->tpl_vars['Web_link']->value,"login");?>
">登陆</a>&nbsp;&nbsp;或&nbsp;&nbsp;<a href="<?php echo smarty_modifier_name($_smarty_tpl->tpl_vars['Web_link']->value,"register");?>
">注册</a>，不能发表留言！
                <?php }?>
